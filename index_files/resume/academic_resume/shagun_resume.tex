...
\lhead{
\small
2200, Waterview Pkwy, Apt 1633\\ 
Richardson, Texas 75080 
}
\rhead{
\small
972-740-4821 (phone) \\
Shagun.Jhaver@utdallas.edu
}
\normalsize
\cfoot{}
...
%		\resitem{Helped design and build the E-commerce platforms for the websites \textit{futurebazaar.com} and \textit{chaupaati.in} using Django, a python based website framework.}
...
%\item
%	\ressubheading{Date-Intensive Text Processing with MapReduce}{\textit{Jan 2013 - Feb 2013}}{Guide: Prof. Latifur Khan}{}
%	\begin{itemize}
...
%\item
%	\ressubheading{Dining Philosophers Project}{\textit{Aug 2012 - Dec 2012}}{Guide: Prof. Jorge Arturo Cobb}{}
%	\begin{itemize}
...
%\item
%	\ressubheading{Adaptive Scheduler}{\textit{Aug 2009 - Nov 2009}}{Guide: Prof. Milind Sohoni}{}
%	\begin{itemize}
%        \resitem{Designed a framework in C++ to generate efficient course schedules. The institute's course schedules, when computed using this framework could predict the potential problems faced by students in the selection of courses, and predict slots if time change was required for a particular course with minimum impact.}
